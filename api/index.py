...
AMHARIC_POPUPS = {
    ...
    "menu_howtoplay": (
        "📖 የጨዋታው መመሪያ"
        "1) ጀምር የሚለውን ተጭነው ይግቡ። 2) አካውንት ይፍጠሩ። 3) usernameና password አስገብተው ይግቡ።" 
        "4) ከ1-500 የሚፈልጉትን ካርድ ይምረጡ። 5) ቁጥሮች ይጠራሉ፣ የእርስዎን ካርድ(ዶች) ከታች ማየት ይችላሉ። "
        "5) ሲያሸንፉ ሲስተሙ በራሱ ያሳውቃል።\n"
        "ማሳሰቢያ፦ ቀሪ ሂሳብዎ ≥20 መሆን አለበት። "
    ),
    "menu_deposit": (
        "💳 ገንዘብ ገቢ\n"
