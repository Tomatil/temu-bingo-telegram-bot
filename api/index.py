...
AMHARIC_POPUPS = {
    ...
    "menu_howtoplay": (
        "📖 የጨዋታው መመሪያ\n\n"
        "1) ጀምር የሚለውን ተጭነው ይግቡ\n" 
        "2) አካውንት ይፍጠሩ የሚለውን ይንኩና ስምዎን username እና password ይፍጠሩ።\n"
        "3) ከዛም username እና passwordዎን አስገብተው ይግቡ።\n"
        "4) ከ1-500 የሚፈልጉትን ካርድ ይምረጡ \n"
        "4) ቁጥሮች ይጠራሉ፣ የእርስዎን ካርድ(ዶች) ከታች ማየት ይችላሉ\n"
        "5) ሲያሸንፉ ሲስተሙ በራሱ ያሳውቃል። ያለዎትን ቀሪ ሂሳብም ይጽፍልዎታል\n\n"
        "ማሳሰቢያ፦ ቀሪ ሂሳብዎ ≥20 መሆን አለበት። ካልሆነ ካርድ መምረጥ አይችሉም።"
    ),
    "menu_deposit": (
        "💳 ገንዘብ ገቢ\n"
